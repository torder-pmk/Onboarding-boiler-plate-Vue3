...
import { _ as _sfc_main$7 } from './TextInput.vue_vue_type_script_setup_true_lang-3d5cce68.js';
import { _ as _sfc_main$9 } from './IconTitle.vue_vue_type_script_setup_true_lang-2d6fc9fc.js';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(Draggable), {
        ...
        group: "tab",
        animation: 200,
        class: "min-h-40px flex-wrap gap3 p2 container",
        "onUpdate:modelValue": _cache[0] || (_cache[0] = (tabs) => {
          unref(updateTabsPosition)(_ctx.groupName, tabs);
        }),
        onStart: _cache[1] || (_cache[1] = ($event) => dragging.value = true),
        onEnd: _cache[2] || (_cache[2] = ($event) => dragging.value = false)
      }, {
        item: withCtx(({ element }) => [
          createBaseVNode("div", {
            class: normalizeClass({ "hover:color-primary hover:bg-gray-2/20": !unref(dragging) }),
            y: "",
            "cursor-pointer": "",
            rounded: "",
            px2: "",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const currentRemovedGroup = ref(null);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$1, [
          ...
          createBaseVNode("div", _hoisted_4$1, [
            ...
            createVNode(_component_VDButton, {
              ...
              "text-white": "",
              "hover:text-white": "",
              disabled: !unref(groupName).trim().length,
              onClick: _cache[3] || (_cache[3] = ($event) => handleCreateGroup())
            }, {
              default: withCtx(() => [
        ...
        createVNode(_component_VDConfirm, {
          ...
          onConfirm: unref(currentConfirmHandlers).handler
        }, null, 8, ["modelValue", "message", "onConfirm"]),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(groupTabs), ([name, { show, tabs }]) => {
            ...
            !unref(shouldHideTabGroup)(name, tabs.length) && show ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
              createBaseVNode("div", _hoisted_6$1, [
                ...
                name !== unref(DEFAULT_TAB_GROUP) ? (openBlock(), createBlock(_component_VDIconButton, {
                  ...
                  onClick: ($event) => {
                    currentRemovedGroup.value = name;
                    handleShowConfirm("remove");
                  }
                }, null, 8, ["onClick"])) : createCommentVNode("", true)
              ]),
              createVNode(_component_TabGroupItem, {
                tabs,
                "group-name": name
              }, null, 8, ["tabs", "group-name"])
...
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("div", null, "Nav group", -1);
...
const _hoisted_16 = /* @__PURE__ */ createBaseVNode("p", null, "Minimize panel on inactive", -1);
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              _hoisted_5,
              createVNode(_component_VTooltip, { placement: "top" }, {
                popper: withCtx(() => [
                  _hoisted_6
                ]),
                default: withCtx(() => [
                  createBaseVNode("button", {
                    ...
                    onClick: _cache[0] || (_cache[0] = ($event) => showTabGroup.value = !unref(showTabGroup))
                  }, [
                    createBaseVNode("div", {
                      "material-symbols-tab-group-outline": "",
                      "transition-colors": "",
                      "hover:text-primary": "",
                      class: normalizeClass({ "text-primary": unref(showTabGroup) })
                    }, null, 2)
                  ])
                ]),
                _: 1
            ...
            !unref(showTabGroup) ? (openBlock(), createElementBlock("div", _hoisted_7, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(groupedTabs), ([name, { tabs }]) => {
                return openBlock(), createElementBlock(Fragment, { key: name }, [
                  tabs.length ? (openBlock(), createElementBlock("div", {
                    ...
                    createVNode(_component_VDSwitch, {
                      ...
                      py1: "",
                      "n-lime": "",
                      "model-value": !unref(hiddenTabGroups).includes(name),
                      "onUpdate:modelValue": (v) => toggleTabCategory(name, v)
                    }, {
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_8, [
                          createBaseVNode("span", _hoisted_9, toDisplayString(name), 1)
                        ])
                      ]),
                      _: 2
          ...
          createBaseVNode("div", null, [
            ...
            createBaseVNode("div", _hoisted_14, [
              ...
              createVNode(_component_VDSelect, {
                modelValue: unref(minimizePanelInactive),
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => isRef(minimizePanelInactive) ? minimizePanelInactive.value = $event : null),
                n: "primary"
              }, {
                default: withCtx(() => [
                  (openBlock(), createElementBlock(Fragment, null, renderList(minimizeInactiveOptions, (i) => {
                    return createBaseVNode("option", {
                      key: i[0],
                      value: i[1]
                    }, toDisplayString(i[0]), 9, _hoisted_17);
                  }), 64))
                ]),
                _: 1
              }, 8, ["modelValue"])
            ...
            createBaseVNode("div", _hoisted_18, [
              ...
              createVNode(_component_VDSelect, {
                ...
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => isRef(scale) ? scale.value = $event : null),
                n: "primary"
              }, {
                default: withCtx(() => [
                  (openBlock(), createElementBlock(Fragment, null, renderList(scaleOptions, (i) => {
                    return createBaseVNode("option", {
                      key: i[0],
                      value: i[1]
                    }, toDisplayString(i[0]), 9, _hoisted_20);
                  }), 64))
                ]),
                _: 1
              }, 8, ["modelValue"])
            ...
            createBaseVNode("div", _hoisted_23, [
              createBaseVNode("h3", _hoisted_24, toDisplayString(unref(sidebarExpanded) ? "Scrollable" : "Expand") + " Sidebar ", 1),
              createVNode(_component_VDSwitch, {
                flex: "~ row-reverse",
                py1: "",
                "n-primary": "",
                "model-value": unref(sidebarExpanded),
                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => sidebarExpanded.value = !unref(sidebarExpanded))
              }, null, 8, ["model-value"])
            ])
          ])
        ])
