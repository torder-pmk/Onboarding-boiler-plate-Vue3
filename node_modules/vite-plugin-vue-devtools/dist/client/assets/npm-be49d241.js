import { v as defineComponent, a$ as ref, aP as onMounted, cm as useEventListener, cn as hookApi, o as openBlock, e as createElementBlock, co as useScrollLock, cp as watchDebounced, cq as useInfiniteScroll, r as resolveComponent, b as resolveDirective, x as createBaseVNode, u as createVNode, z as unref, aC as isRef, h as withCtx, F as Fragment, i as renderList, c as createBlock, g as createCommentVNode, ci as rpc, y as toDisplayString, d as withDirectives, a9 as createTextVNode, a7 as createSlots, q as normalizeClass, bM as _sfc_main$3 } from './index-36a8f2c8.js';
import { _ as __unplugin_components_3 } from './SectionBlock-90af9bd1.js';
import { _ as _sfc_main$2 } from './TextInput.vue_vue_type_script_setup_true_lang-3d5cce68.js';
import { a as getDefaultExportFromCjs, c as commonjsGlobal } from './_commonjsHelpers-7e83dbf2.js';
...
var xtermAddonFit = {exports: {}};/* Injected with object hook! */

(function (module, exports) {
	!function(e,t){module.exports=t();}(self,(()=>(()=>{var e={};return (()=>{var t=e;Object.defineProperty(t,"__esModule",{value:!0}),t.FitAddon=void 0,t.FitAddon=class{activate(e){this._terminal=e;}dispose(){}fit(){const e=this.proposeDimensions();if(!e||!this._terminal||isNaN(e.cols)||isNaN(e.rows))return;const t=this._terminal._core;this._terminal.rows===e.rows&&this._terminal.cols===e.cols||(t._renderService.clear(),this._terminal.resize(e.cols,e.rows));}proposeDimensions(){if(!this._terminal)return;if(!this._terminal.element||!this._terminal.element.parentElement)return;const e=this._terminal._core,t=e._renderService.dimensions;if(0===t.css.cell.width||0===t.css.cell.height)return;const r=0===this._terminal.options.scrollback?0:e.viewport.scrollBarWidth,i=window.getComputedStyle(this._terminal.element.parentElement),o=parseInt(i.getPropertyValue("height")),s=Math.max(0,parseInt(i.getPropertyValue("width"))),n=window.getComputedStyle(this._terminal.element),l=o-(parseInt(n.getPropertyValue("padding-top"))+parseInt(n.getPropertyValue("padding-bottom"))),a=s-(parseInt(n.getPropertyValue("padding-right"))+parseInt(n.getPropertyValue("padding-left")))-r;return {cols:Math.max(2,Math.floor(a/t.css.cell.width)),rows:Math.max(1,Math.floor(l/t.css.cell.height))}}};})(),e})()));
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      hookApi.hook.on("__vue-devtools:terminal:data__", (data) => {
        term.write(data);
      });
...
var algoliasearch_umd = {exports: {}};/* Injected with object hook! */
...
var algoliasearch_umdExports = algoliasearch_umd.exports;
...
const _hoisted_3 = { "w-full": "" };
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("thead", { border: "b base" }, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", { "text-left": "" }, " Name "),
    /* @__PURE__ */ createBaseVNode("th", { "text-left": "" }, " Version "),
    /* @__PURE__ */ createBaseVNode("th", { "text-center": "" }, " Type "),
    /* @__PURE__ */ createBaseVNode("th", { "text-center": "" }, " Uninstall ")
  ])
], -1);
const _hoisted_5 = {
  "text-sm": "",
...
const _hoisted_13 = { "w-full": "" };
const _hoisted_14 = /* @__PURE__ */ createBaseVNode("thead", { border: "b base" }, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", { "text-left": "" }, " Name "),
    /* @__PURE__ */ createBaseVNode("th", { "text-left": "" }, " Version "),
    /* @__PURE__ */ createBaseVNode("th", { "text-left": "" }, " Author "),
    /* @__PURE__ */ createBaseVNode("th", { "text-left": "" }, " Downloads "),
    /* @__PURE__ */ createBaseVNode("th", { "text-center": "" }, " Download ")
  ])
], -1);
const _hoisted_15 = {
  "text-sm": "",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function toggleVersion(item, version) {
      item.activeVersion = version;
    }
    async function download(item, isDev) {
    ...
    async function uninstall(item, type) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createVNode(_component_VDSectionBlock, {
          ...
          description: `found ${toThousands(unref(projectDeps).length)} packages`,
          padding: "0"
        }, {
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_2, [
              createBaseVNode("table", _hoisted_3, [
                ...
                createBaseVNode("tbody", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(projectDeps), (item, index) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_7, [
                        createBaseVNode("div", _hoisted_8, toDisplayString(item.version), 1)
                      ]),
                      createBaseVNode("td", _hoisted_9, [
                        createBaseVNode("div", _hoisted_10, toDisplayString(item.type), 1)
                      ]),
        ...
        createVNode(_component_VDSectionBlock, {
          ...
          text: "Search Results",
          description: `found ${toThousands(unref(total))} packages in ${unref(responseTime)}ms`,
          padding: "0"
        }, {
          default: withCtx(() => [
                    ...
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_15, [
                        createBaseVNode("div", _hoisted_16, [
                          createVNode(_component_VTooltip, { placement: "top" }, createSlots({
                            default: withCtx(() => [
                              item?.repository?.url ? (openBlock(), createElementBlock("a", {
                                key: 0,
                                href: item.repository.url,
                                target: "_blank",
                                hover: "text-primary"
                              }, toDisplayString(item.name), 9, _hoisted_17)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      ...
                      createVNode(_component_VDropdown, {
                        ...
                        popper: withCtx(() => [
                          createBaseVNode("ul", _hoisted_19, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(item.versions).reverse(), (version) => {
                              return withDirectives((openBlock(), createElementBlock("li", {
                                key: version,
                                border: "b dashed transparent",
                                class: normalizeClass(["group", String(item.activeVersion ?? item.version) === version ? "text-primary" : ""]),
                                hover: "bg-active",
                                "h-7": "",
                                "cursor-pointer": "",
                                "px-3": "",
                                "text-center": "",
                                "lh-7": "",
                                onClick: ($event) => toggleVersion(item, version)
                              }, [
                                createTextVNode(toDisplayString(version), 1)
                              ], 10, _hoisted_20)), [
                                [_directive_close_popper]
                              ]);
                            }), 128))
                        ...
                        default: withCtx(() => [
                          createBaseVNode("td", _hoisted_18, toDisplayString(item.activeVersion ?? item.version), 1)
                        ]),
                        _: 2
                      }, 1024),
                      createBaseVNode("td", _hoisted_21, [
                        createBaseVNode("a", {
                          ...
                          target: "_blank"
                        }, toDisplayString(item?.owner?.name ?? "-"), 9, _hoisted_22)
                      ]),
                      createBaseVNode("td", _hoisted_23, toDisplayString(item.humanDownloadsLast30Days), 1),
        ...
        unref(terminalVisible) ? (openBlock(), createBlock(_component_TerminalView, {
          key: 0,
          absolute: "",
          "left-0": "",
          "top-0": "",
